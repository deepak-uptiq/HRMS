 ...
 *         description: Forbidden
 */
router.patch('/:id/approve', auditLog('APPROVE', 'USER'), catchAsync(approveUser));

/**
 * @swagger
 * /api/v1/users/{id}/reject:
 *   patch:
 *     summary: Reject user (Admin only)
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         description: Forbidden
 */
router.patch('/:id/reject', auditLog('REJECT', 'USER'), catchAsync(rejectUser));
