 ...
 * /api/v1/performance-reviews/{id}:
 *   patch:
 *     summary: Update performance review status (HR/Admin only)
 *     tags: [Performance Reviews]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Performance review status updated
 *       404:
 *         description: Performance review not found
 *       401:
 *         description: Unauthorized
 ...
 *         description: Forbidden
 */
router.patch('/:id', authorize('ADMIN', 'HR'), catchAsync(updatePerformanceReview));
