 ...
 *   post:
 *     summary: Generate bulk payslips (HR/Admin only)
 *     tags: [Payslips]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     responses:
 *       201:
 *         description: Bulk payslips generated successfully
 *       400:
 ...
 *         description: Forbidden
 */
router.post('/bulk', authorize('ADMIN', 'HR'), validate(generatePayslipsSchema), auditLog('GENERATE', 'PAYSLIP'), catchAsync(generatePayslips));
 ...
 * /api/v1/payslips/{id}:
 *   patch:
 *     summary: Update payslip status (HR/Admin only)
 *     tags: [Payslips]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Payslip status updated
 *       404:
 *         description: Payslip not found
 *       401:
 *         description: Unauthorized
 ...
 *         description: Forbidden
 */
router.patch('/:id', authorize('ADMIN', 'HR'), catchAsync(updatePayslip));
